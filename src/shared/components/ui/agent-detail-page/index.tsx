      ...
      >
        ...
        <Box sx={{ order: { xs: 2, md: 1 }, position: 'relative', zIndex: 1 }}>
          ...
          >
            ...
            >
              <span style={{ position: 'relative', zIndex: 10 }}>Essayer gratuitement</span>
            ...
            >
              <span style={{ position: 'relative', zIndex: 10 }}>Réserver une démo</span>
        ...
        >
          ...
          >
            <ConditionalComponent isValid={Boolean(avatar)}>
              <Image
                src={avatar}
                alt={agentName}
                fill
